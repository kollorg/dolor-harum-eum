...
**This is an advanced API**. It lets you build an arbitrary provider wrapper around your component. [See the example.](https://@kollorg/dolor-harum-eum.pages.dev/?path=/story/advanced--theming)
